    ...
    public static class DbInitializer
    {
        ...
        private static void CreateTags(ApplicationDbContext context)
        {
            ...
            var tags = new Tag[]
            {
                ...
                new Tag { Name = "опыт 1-3 года" },
                new Tag { Name = "опыт 3-6 лет" },
                new Tag { Name = "опыт более 6 лет" },
                new Tag { Name = "фиксированный график" },
                new Tag { Name = "гибкий график" },
                new Tag { Name = "трудовой договор" },
                new Tag { Name = "ГПХ" },
                new Tag { Name = "работа из офиса" },
                new Tag { Name = "работа удаленно" },
                new Tag { Name = "работа из офиса и удаленно (гибрид)" },
                new Tag { Name = "полная занятость" },
                new Tag { Name = "частичная занятость" },
                new Tag { Name = "вахта" },
                new Tag { Name = "стажировка" },
                new Tag { Name = "предоставление проживания" },
                new Tag { Name = "предоставление транспорта" },
                new Tag { Name = "трансфер до места работы" },
            };
